...
// export function displayedSuffixPrefixOverlap(
...
// export function sameDisplayMessage(left: ChatMessage, right: ChatMessage | undefined): boolean {
// 	return Boolean(
// 		right &&
...
// export function sameUserPromptMessage(
