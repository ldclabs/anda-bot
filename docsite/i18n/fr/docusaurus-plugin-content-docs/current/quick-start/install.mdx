...
L'installateur Windows enregistre Anda au démarrage de session de l'utilisateur actuel et tente de lancer le daemon immédiatement. Ajoutez `-NoAutostart` ou `-NoStart` pour désactiver ces actions.
