...
تسجل مثبتات الإصدار تشغيل Anda عند تسجيل دخول المستخدم الحالي وتحاول بدء daemon فورًا. في PowerShell أضف `-NoAutostart` أو `-NoStart`؛ وفي مثبت shell استخدم `ANDA_NO_AUTOSTART=1` أو `ANDA_NO_START=1`.
