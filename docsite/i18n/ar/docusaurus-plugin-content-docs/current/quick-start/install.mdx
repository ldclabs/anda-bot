...
تسجل مثبتات الإصدار تشغيل Anda عند تسجيل دخول المستخدم الحالي وتحاول بدء daemon فورًا. في Windows وmacOS يستطيع launcher في الشريط أو شريط القوائم أيضًا التحقق من التحديثات وتنزيلها ثم مطالبتك بإعادة التشغيل لتثبيتها. في PowerShell أضف `-NoAutostart` أو `-NoStart`؛ وفي مثبت shell استخدم `ANDA_NO_AUTOSTART=1` أو `ANDA_NO_START=1`.
...
تجعل علامة `brain` هذا المزود مفضلاً لمهام الذاكرة.
