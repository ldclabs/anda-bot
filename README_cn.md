...
### Anda DB
[**Anda DB**](https://github.com/ldclabs/anda-db) 是驱动认知纽带的嵌入式数据库引擎。它采用 Rust 编写，具有极高的性能和内存安全性，原生支持图谱遍历、多模态数据和向量相似性——所有这些都为 AI 工作负载进行了优化。

## 快速开始

有关详细的技术文档、API 规范和集成指南，请参见 [anda_hippocampus/README.md](./anda_hippocampus/README.md)。
